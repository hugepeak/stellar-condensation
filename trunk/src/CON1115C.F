...
C     B.J. Wood and J. Nicholls (1978) Contrib. Mineral. Petrol. 66, 389-400
        ...
        a=1d0/dlog(10d0)
        gamma(1)=-a*xmg*xal*deltag
        gamma(2)=a*xfe*xal*deltag
        gamma(3)=a*xmg*xcr*deltag
        gamma(4)=-a*xfe*xcr*deltag
        dgamma(1,1)=a*xmg*deltag
        dgamma(2,1)=-a*xfe*deltag
        dgamma(3,1)=a*xmg*deltag
        dgamma(4,1)=-a*xfe*deltag
